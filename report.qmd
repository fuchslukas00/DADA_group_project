...
Ridge regression is a form of regularization. Regularization methods impose a penalty on large coefficients, which reduces the fit of the model
to the training data (increases bias), but ideally thereby increases the model's generalizability/applicability to unseen data (decreases variance).
